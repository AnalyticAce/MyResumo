...
def handle_generate_page(app: AppSection, API_KEY: str) -> None:
    ...
    if generation and template_1:
        st.write('We are are currently working on deployement, if you want to test the project visit https://github.com/AnalyticAce/MyResumo and clone of the main branch')
        """
