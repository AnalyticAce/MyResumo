...
class TokenTracker:
    ...
    def get_usage_summary(
        ...
        for record in filtered_records:
            ...
            usage_by_model[record.model_name]["calls"] += 1
            usage_by_model[record.model_name]["prompt_tokens"] += record.prompt_tokens
            usage_by_model[record.model_name]["completion_tokens"] += record.completion_tokens
            usage_by_model[record.model_name]["total_tokens"] += record.total_tokens
            usage_by_model[record.model_name]["cost_usd"] += record.cost_usd
